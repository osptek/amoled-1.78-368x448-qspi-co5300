...
#ifndef ESP_LCD_QSPI_AMOLED_VER_MAJOR
#define ESP_LCD_QSPI_AMOLED_VER_MAJOR 1
#define ESP_LCD_QSPI_AMOLED_VER_MINOR 0
#define ESP_LCD_QSPI_AMOLED_VER_PATCH 0
#endif
